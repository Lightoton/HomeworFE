...
//Составьте программу, которая принимает с клавиатуры целое число и, если оно положительное, выводит его куб.***В задании не указано что нужно вывести в консоль переменную.
